...
// check if fields passed are empty  
 ...
 $to = 'stacy.fabian.pdx@gmail.com';  
 $email_subject = "Website contact form submitted by:  $name"; $email_body = "You have received a new contact request from stacyfabian.com. \n\n".                 
                   " Here are the details:\n \nName: $name \n ". 
                   "Email: $email_address\n Message \n $message"; 
 $headers = "From: Website Visitor\n"; 
